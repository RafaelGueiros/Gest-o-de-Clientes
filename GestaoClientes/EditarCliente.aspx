<%@ Page Language="C#" MasterPageFile="Index.Master" AutoEventWireup="true" CodeBehind="EditarCliente.aspx.cs" Inherits="GestaoClientes.EditarCliente" %>
    ...
    <div class="col-md-12" id="Div12">
        <div id="divArquivos" class="" style="min-height:680px; width:100%; border:solid; border-width:1px; border-color:#F5F5F5">
            <div style="background-color: #0061A1; height:65px;">
                <br /><center><span style="color:white; font-size:20px; font-weight:bold; font-family:Calibri">EDITAR CLIENTE <label id="NomeOperacao"></label></span></center>
            </div><br />
                ...
                <div class="col-md-12" id="div1">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-3" id="divCPF">
                            ...
                            <asp:TextBox ID="txtCPF" runat="server" class="form-control" readonly></asp:TextBox>
                        </div>
                        <div class="col-sm-3 ">
